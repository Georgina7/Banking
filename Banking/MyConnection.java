...
public class MyConnection 
{
    ...
    public void newAccount(String fname, String lname, String email, int id, int phoneNo, String KRA, String pin)
    {
        //int acc = 0;        
        try
        {
            DoConnect();
            ps = conn.prepareStatement("Insert into accounts (FName, LName, Email, ID_Number, PhoneNo, KRA_Pin, Pin) values (?,?,?,?,?,?,?)");
